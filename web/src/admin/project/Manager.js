...
module.exports = React.createClass({
	...
	__onTypeChange: function (value){
		...
		this.state.data._data.where = "locate(',"+value.value+",', role_ids)<>0";
		this.state.data.refresh();
	},
	render:function(){
		return (
			<zn.react.Page title="经理及执行"
				...
				toolbarItems={this.state.toolbarItems} onToolbarClick={this.__onToolbarClick}>
				<zn.react.PagerView
					ref="table"
					view="Table"
					enableFilter={true}
